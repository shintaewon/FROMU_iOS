...
class EditScheduleViewController: UIViewController {
    ...
    lazy private var textField: UITextField = {
        ...
        textField.text = scheduleContent
    ...
    @objc private func completeButtonTapped() {
        ...
        editCalendarSchedule(scheduleId: self.scheduleId, content: textField.text ?? "None" , date: dateString)
    ...
    private func editCalendarSchedule(scheduleId: String, content: String, date: String) {
        ScheduleAPI.providerSchedule.request(.editSchedule(scheduleId: scheduleId, content: content, date: date)) { result in
            switch result {
