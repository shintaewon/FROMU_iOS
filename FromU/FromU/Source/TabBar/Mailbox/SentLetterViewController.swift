//
//  SentLetterViewController.swift
//  FromU
//
...
class SentLetterViewController: UIViewController {
...
extension SentLetterViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        else if letters[indexPath.row].status == 1 {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = letter.mailboxName + "으로 편지를 보냈어."
...
extension SentLetterViewController{
    
    func getLetterList() {
        LetterAPI.providerLetter.request(.getLetterList(type: "1")) { result in
            switch result {
